...
const BirthdayEvent = {
    ...
    loadStyles() {
        ...
        link.id = 'birthday-styles';
        link.rel = 'stylesheet';
        link.href = 'event/birthday_module/birthday_event.css';
    ...
    startFalling() {
        ...
        this.present.src = 'event/birthday_module/images/FallingPresent.svg';
    ...
    onLanded() {
        ...
        this.present.src = 'event/birthday_module/images/Present.svg';
        ...
        if (this.state === 'PUSHING_PRESENT') {
            if (this.present && document.body.contains(this.present)) {
                ...
                if (Math.abs(distToCenter) < 10) {
                    ...
                    setTimeout(() => {
                        if (this.present) {
                            this.present.src = 'event/birthday_module/images/OpenPresent.svg';
    ...
    showBirthdayPhoto() {
        const photoSrc = 'event/birthday_module/images/HappyBirthDayMum.png';
        ...
        setTimeout(() => {
            ...
            setTimeout(() => {
                ...
                if (typeof AudioManager !== 'undefined') {
                    ...
                    if (!audio) {
                        audio = new Audio('event/birthday_module/audio/Happy Birthday To You.mp3');
